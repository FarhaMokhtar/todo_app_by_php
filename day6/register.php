...
<form class="form" action="./registerlogic.php" method="post">
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control" id="inputdepart" name="department">
      <?php if (isset($_GET['department'])) { ?>
            <p class="error"><?php echo $_GET['department']; ?></p>
        <?php } ?>
    </div>
